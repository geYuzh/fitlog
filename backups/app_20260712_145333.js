...
var defaultCategories = {
  '胸': ['自由卧推', '史密斯平板卧推', '上斜卧推', '下斜卧推', '绳索夹胸', '双杠臂屈伸', '器械平板卧推', '哑铃平板卧推', '蝴蝶机夹胸', '俯卧撑', '史密斯宽距卧推'],
  '背': ['高位下拉', '山羊挺身', '引体向上', '杠铃划船', '单臂哑铃划船', '坐姿划船', '面拉', '宽距引体', '窄距引体', '对握引体', 'T杠划船', '直臂下压', '单臂高位下拉', '鹦鹉螺', '大剪刀'],
  '腿': ['深蹲', '硬拉', '腿举', '罗马尼亚硬拉', '腿弯举', '腿屈伸', '保加利亚分腿蹲', '臀推', '哈克机深蹲', '单腿硬拉', '史密斯深蹲'],
  '肩': ['坐姿哑铃推肩', '侧平举', '前平举', '面拉', '阿诺德推举', '直立划船', '器械推肩', '实力举', '绳索侧平举', '反向飞鸟', '哑铃飞鸟'],
  '手臂': ['二头弯举', '三头下压', '杠铃弯举', '锤式弯举', '绳索下压', '窄距卧推', '牧师凳弯举', '正握弯举', '器械二头弯举', '二十一响炮', '站立臂屈伸', '哑铃弯举'],
  '臀': ['臀推', '保加利亚分腿蹲', '跪羊提腿', '臀桥', '坐姿髋外展', '大腿内侧内收'],
